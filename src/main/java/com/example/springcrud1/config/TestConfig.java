...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2023-02-18T20:53:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2023-02-20T14:13:07Z"), u2);
        Order o3 = new Order(null, Instant.parse("2023-02-23T08:55:07Z"), u1);
